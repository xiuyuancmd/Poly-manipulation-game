...
export default {
  ...
  targets: [
    {
      name: '橄榄',
      outlines: [ellipse(CX, CY, 150, 67)],
      pipes: [{ points: line(CX - 95, CY, CX + 95, CY, 8), closed: false }],
      hint: '抓住左右两端往外拉；或者钉住一端，拖另一端。',
    },
    {
      name: '弯月',
      outlines: [arcCapsule(CX, CY + 115, 130, 38, -Math.PI * 5 / 6, -Math.PI / 6)],
      pipes: [{ points: arc(CX, CY + 115, 130, -Math.PI * 5 / 6, -Math.PI / 6, 12), closed: false }],
